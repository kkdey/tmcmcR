...
for ( l in 1:L)
{
  Mult_Mattingly[1,l,,] <- rtmc3(pdf,beta_set=beta_set,base=base, scale=1, nsamples=2000, verb=FALSE)$chain;
  Mult_Mattingly[2,l,,] <- rmc3(pdf,beta_set=beta_set, base=base, scale=1, nsamples=2000, verb=FALSE)$chain;
