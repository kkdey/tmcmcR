...
Next we compare the performances of the adaptive versions of TMCMC against the test distribution and see how the three adaptive methods - due to Atchade, Haario and the RAMA methods perform cin comparison to each other. 
